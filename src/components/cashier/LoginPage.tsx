    ...
    <div className="min-h-screen flex items-center justify-center bg-background p-5">
      <Card className="w-full max-w-[420px] bg-card border-border">
        <CardHeader className="text-center pb-2">
          ...
          <CardTitle className="text-2xl font-bold">Kassir Panel</CardTitle>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div className="space-y-2">
              ...
              <Input
                ...
                maxLength={17}
                disabled={isLoading}
                className="h-12 bg-secondary border-border focus:border-[#22c55e] focus:ring-[#22c55e]/10"
              />
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  disabled={isLoading}
                  className="h-12 bg-secondary border-border pr-12 focus:border-[#22c55e] focus:ring-[#22c55e]/10"
                />
                <button
                  type="button"
            ...
            <Button
              ...
              className="w-full h-12 bg-gradient-to-r from-[#22c55e] to-[#059669] hover:opacity-90 text-white font-semibold text-base"
            >
